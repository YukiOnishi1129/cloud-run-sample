...
var (
	userAllColumns            = []string{"id", "name", "email", "password", "image_url", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"name", "email", "password"}
	userColumnsWithDefault    = []string{"id", "image_url", "created_at", "updated_at", "deleted_at"}
